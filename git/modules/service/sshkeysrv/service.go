...
func ListAllPubKeyByAccount(ctx context.Context, account string) []InnerSshKeyDTO {
...
func CreateSshKey(ctx context.Context, reqDTO CreateSshKeyReqDTO) error {
	if err := reqDTO.IsValid(); err != nil {
		return err
	}
...
func ListSshKey(ctx context.Context, reqDTO ListSshKeyReqDTO) ([]SshKeyDTO, error) {
	if err := reqDTO.IsValid(); err != nil {
		return nil, err
	}
	ctx, closer := xormstore.Context(ctx)
