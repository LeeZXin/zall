...
func Lock(ctx context.Context, reqDTO LockReqDTO) (LockRespDTO, error) {
...
func Unlock(ctx context.Context, reqDTO UnlockReqDTO) (LfsLockDTO, error) {
	if err := reqDTO.IsValid(); err != nil {
...
func Verify(ctx context.Context, reqDTO VerifyReqDTO) (bool, bool, error) {
	if err := reqDTO.IsValid(); err != nil {
...
func Download(ctx context.Context, reqDTO DownloadReqDTO) error {
	if err := reqDTO.IsValid(); err != nil {
		return err
	}
	// 检查仓库访问权限
