...
func deployService(config *deploymd.Config, product, env, operator string, planId int64) error {
	return nil
}
...
//			command := workflow.NewServiceCommand(p.AgentHost, p.AgentToken, config.AppId)
...
//				ScriptOutput:   result,
//				Env:            env,
//				Product: service.CurrProductVersion,
