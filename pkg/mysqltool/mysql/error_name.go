...
var MySQLErrName = map[uint16]string{
	...
	ErrHostIsBlocked:                            "App '%-.64s' is blocked because of many connection errors; unblock with 'mysqladmin flush-hosts'",
	ErrHostNotPrivileged:                        "App '%-.64s' is not allowed to connect to this MySQL server",
	...
	ErrSpBadCursorQuery:                         "PageNum statement must be a SELECT",
	ErrSpBadCursorSelect:                        "PageNum SELECT must not have INTO",
	ErrSpCursorMismatch:                         "Undefined CURSOR: %s",
	ErrSpCursorAlreadyOpen:                      "PageNum is already open",
	ErrSpCursorNotOpen:                          "PageNum is not open",
	...
	ErrSpCursorAfterHandler:                     "PageNum declaration after handler declaration",
	...
	ErrNameBecomesEmpty:                         "Alias '%-.64s' has become ''",
	...
	ErrFuncInexistentNameCollision:                           "FUNCTION %s does not exist. Check the 'Function Alias Parsing and Resolution' section in the Reference Manual",
	...
	ErrMtsCantParallel:                                       "Cannot execute the current event group in the parallel mode. Encountered event %s, relay-log name %s, position %s which prevents execution of this event group in parallel mode. ApplyReason: %s.",
	...
	ErrAlterOperationNotSupportedReason:                      "%s is not supported. ApplyReason: %s. Try %s.",
