...
var MySQLErrName = map[uint16]string{
	...
	ErrHostIsBlocked:                            "Name '%-.64s' is blocked because of many connection errors; unblock with 'mysqladmin flush-hosts'",
	ErrHostNotPrivileged:                        "Name '%-.64s' is not allowed to connect to this MySQL server",
